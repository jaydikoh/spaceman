...
const correctWordEl = document.querySelector(".correct-word");                    //selecting the gameover element
...
function init() {
  ...
  correctWordEl.style.visibility = 'hidden';
  keyboardButtons.forEach((button) => {
...
function getWinner() {
  ...
  if (remainingGuesses <= 0) {
    correctWordEl.style.display = "block";
    correctWordEl.textContent = `The word was "${selectedWord.word}"`;
    correctWordEl.style.visibility = 'visible';
